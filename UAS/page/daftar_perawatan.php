<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Daftar Perawatan</h1>
            </div>
        </div>
    </div>
</div>
...
if (isset($_POST['daftar'])) {
    ...
    $stmt = mysqli_prepare($koneksi, "INSERT INTO perawatan
        (nama, tanggal_lahir, umur, alamat, poli, dokter, jam_perawatan, tanggal_daftar)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    ");
    ...
    if ($insert) {
        ...
        <div class="alert alert-success alert-dismissible">
            ...
            <i class="icon fas fa-check"></i> Pendaftaran perawatan berhasil! Silakan datang sesuai jadwal yang dipilih.
        </div>';
            ...
            <div class="col-lg-7 col-xl-6">
                ...
                <div class="card card-outline card-primary shadow-sm">
                    ...
                    <div class="card-header d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="card-title mb-0" style="font-size:16px;">Pendaftaran Perawatan</h3>
                        </div>
                    </div>
                        ...
                        <form method="POST">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="time"
                                           name="jam_perawatan"
                                           value="<?= isset($jam_perawatan) ? htmlspecialchars($jam_perawatan) : '' ?>"
                                           class="form-control"
                                           required>
                                </div>
