        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="index.php?page=tambah_medical_checkup"
                    class="btn btn-primary btn-sm">
                    <i class="fas fa-plus"></i> Tambah Medical Check Up
                    </a>
                </div>
            </div>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="index.php?page=medical_checkup&action=hapus&id=<?= urlencode($data['id_checkup']) ?>"
