<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Tambah Medical Check Up</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-lg-7 col-xl-6">
                ...
                <div class="card card-outline card-primary shadow-sm">
                    ...
                    <div class="card-header d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="card-title mb-0" style="font-size:16px;">Tambah Medical Check Up</h3>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Jam medical checkup</label>
                                    <input type="time"
                                           name="jam_checkup"
